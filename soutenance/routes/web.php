...
// Route::get('gestF', function () {
//     return view('directeur.gestion_Formateurs');
// })->name('formateurs');

// Route::get('gestS', function () {
//     return view('directeur.gestion_Stagiaires');
// })->name('stagiaires');
...
// Route::get('gestM', function () {
//     return view('directeur.gestion_Modules');
// })->name('modules');
...
// Route::get('ajouM', function () {
//     return view('directeur.ajouter_Module');
// })->name('ajouM');
// Route::get('ajouS', function () {
//     return view('directeur.ajouter_Stagiaire');
// })->name('ajouS');
